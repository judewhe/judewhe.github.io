...
function UpgradeClick(){
    if (score >= upgrade_req){
        ...
        document.getElementById("upgrade1").textContent="Upgrade Click Strength: "+String(upgrade_req)+" Clicks";
        if (score < upgrade_req){
            if (document.getElementById("upgrade1").classList.contains("upgrade_locked") == false){
